...
f_y_down_sample = downsample(downsample(f_y,2).',2).';
% 2 times upsample y
f_y_1 = upsample_replicate(upsample_replicate(f_y_down_sample,2).',2).';
% back to RGB
f_ycbcr_2 = cat(3,f_y_1,f_cb,f_cr);
f_rgb_2 = ycbcr2rgb(f_ycbcr_2);
...
subplot(1,num_plot,3)
imshow(f_rgb_2)
title("downsample & upsampled in y")


%% function
% A = [1 2 3 4 5 6 7 8 9];
% upsample_replicate(A,2)
